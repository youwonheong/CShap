...
namespace DatabaseView {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StudentRow AddStudentRow(int Id, string Name, string Phone, int Score) {
            ...
            public string Phone {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("\'Student\' 테이블의 \'Phone\' 열의 값이 DBNull입니다.", e);
                    }
                }
                set {
...
namespace DatabaseView.Database1DataSetTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Student] WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Score = 1 AND [Score] IS NULL) OR ([Score] = @Original_Score)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Student] ([Id], [Name], [Phone], [Score]) VALUES (@Id, @Name, " +
                "@Phone, @Score);\r\nSELECT Id, Name, Phone, Score FROM Student WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [Id] = @Id, [Name] = @Name, [Phone] = @Phone, [Score] = @Score WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Score = 1 AND [Score] IS NULL) OR ([Score] = @Original_Score)));
SELECT Id, Name, Phone, Score FROM Student WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DatabaseView.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Phone, Score FROM dbo.Student";
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Phone, global::System.Nullable<int> Original_Score) {
        ...
        public virtual int Insert(int Id, string Name, string Phone, global::System.Nullable<int> Score) {
        ...
        public virtual int Update(int Id, string Name, string Phone, global::System.Nullable<int> Score, int Original_Id, string Original_Name, string Original_Phone, global::System.Nullable<int> Original_Score) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Phone, global::System.Nullable<int> Score, int Original_Id, string Original_Name, string Original_Phone, global::System.Nullable<int> Original_Score) {
            return this.Update(Original_Id, Name, Phone, Score, Original_Id, Original_Name, Original_Phone, Original_Score);
        }
    }
